...
public class LauncherFiles {
    ...
    public static final String SHARED_PREFERENCES_KEY = "com.mytouch.launcher3.prefs";
    public static final String WALLPAPER_CROP_PREFERENCES_KEY =
            "WallpaperCropActivity";
    public static final String MANAGED_USER_PREFERENCES_KEY = "com.mytouch.launcher3.managedusers.prefs";
