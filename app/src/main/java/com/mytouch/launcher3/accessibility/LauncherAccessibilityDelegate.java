package com.mytouch.launcher3.accessibility;
...
import com.mytouch.launcher3.AppInfo;
import com.mytouch.launcher3.AppWidgetResizeFrame;
import com.mytouch.launcher3.CellLayout;
import com.mytouch.launcher3.DeleteDropTarget;
import com.mytouch.launcher3.DragSource;
import com.mytouch.launcher3.Folder;
import com.mytouch.launcher3.FolderInfo;
import com.mytouch.launcher3.InfoDropTarget;
import com.mytouch.launcher3.ItemInfo;
import com.mytouch.launcher3.Launcher;
import com.mytouch.launcher3.LauncherAppWidgetHostView;
import com.mytouch.launcher3.LauncherAppWidgetInfo;
import com.mytouch.launcher3.LauncherModel;
import com.mytouch.launcher3.LauncherSettings;
import com.mytouch.launcher3.PendingAddItemInfo;
import com.mytouch.launcher3.ShortcutInfo;
import com.mytouch.launcher3.UninstallDropTarget;
import com.mytouch.launcher3.Workspace;
import com.mytouch.launcher3.util.Thunk;
import com.mytouch.launcher3.DragController;
...
public class LauncherAccessibilityDelegate extends AccessibilityDelegate implements DragController.DragListener {
    ...
    private static final int REMOVE = com.mytouch.launcher3.R.id.action_remove;
    private static final int INFO = com.mytouch.launcher3.R.id.action_info;
    private static final int UNINSTALL = com.mytouch.launcher3.R.id.action_uninstall;
    private static final int ADD_TO_WORKSPACE = com.mytouch.launcher3.R.id.action_add_to_workspace;
    private static final int MOVE = com.mytouch.launcher3.R.id.action_move;
    private static final int MOVE_TO_WORKSPACE = com.mytouch.launcher3.R.id.action_move_to_workspace;
    private static final int RESIZE = com.mytouch.launcher3.R.id.action_resize;
    ...
    public LauncherAccessibilityDelegate(Launcher launcher) {
        ...
        mActions.put(REMOVE, new AccessibilityAction(REMOVE,
                launcher.getText(com.mytouch.launcher3.R.string.delete_target_label)));
        mActions.put(INFO, new AccessibilityAction(INFO,
                launcher.getText(com.mytouch.launcher3.R.string.info_target_label)));
        mActions.put(UNINSTALL, new AccessibilityAction(UNINSTALL,
                launcher.getText(com.mytouch.launcher3.R.string.delete_target_uninstall_label)));
        mActions.put(ADD_TO_WORKSPACE, new AccessibilityAction(ADD_TO_WORKSPACE,
                launcher.getText(com.mytouch.launcher3.R.string.action_add_to_workspace)));
        mActions.put(MOVE, new AccessibilityAction(MOVE,
                launcher.getText(com.mytouch.launcher3.R.string.action_move)));
        mActions.put(MOVE_TO_WORKSPACE, new AccessibilityAction(MOVE_TO_WORKSPACE,
                launcher.getText(com.mytouch.launcher3.R.string.action_move_to_workspace)));
        mActions.put(RESIZE, new AccessibilityAction(RESIZE,
                        launcher.getText(com.mytouch.launcher3.R.string.action_resize)));
    }
    ...
    public boolean performAction(final View host, final ItemInfo item, int action) {
        if (action == REMOVE) {
            if (DeleteDropTarget.removeWorkspaceOrFolderItem(mLauncher, item, host)) {
                announceConfirmation(com.mytouch.launcher3.R.string.item_removed);
                return true;
            }
            return false;
        } else if (action == INFO) {
            ...
            mLauncher.showWorkspace(true, new Runnable() {
                ...
                public void run() {
                    ...
                    announceConfirmation(com.mytouch.launcher3.R.string.item_added_to_workspace);
                }
            });
            return true;
            ...
            new Handler().post(new Runnable() {
                ...
                public void run() {
                    ...
                    itemList.add(item);
                    mLauncher.bindItems(itemList, 0, itemList.size(), true);
                    announceConfirmation(com.mytouch.launcher3.R.string.item_moved);
                }
            });
            ...
            new AlertDialog.Builder(mLauncher)
                .setTitle(com.mytouch.launcher3.R.string.action_resize)
    ...
    private ArrayList<Integer> getSupportedResizeActions(View host, LauncherAppWidgetInfo info) {
        ...
        if ((providerInfo.resizeMode & AppWidgetProviderInfo.RESIZE_HORIZONTAL) != 0) {
            if (layout.isRegionVacant(info.cellX + info.spanX, info.cellY, 1, info.spanY) ||
                ...
                actions.add(com.mytouch.launcher3.R.string.action_increase_width);
            }

            if (info.spanX > info.minSpanX && info.spanX > 1) {
                actions.add(com.mytouch.launcher3.R.string.action_decrease_width);
            }
        }
        ...
        if ((providerInfo.resizeMode & AppWidgetProviderInfo.RESIZE_VERTICAL) != 0) {
            if (layout.isRegionVacant(info.cellX, info.cellY + info.spanY, info.spanX, 1) ||
                ...
                actions.add(com.mytouch.launcher3.R.string.action_increase_height);
            }

            if (info.spanY > info.minSpanY && info.spanY > 1) {
                actions.add(com.mytouch.launcher3.R.string.action_decrease_height);
            }
        }
        return actions;
    }
    ...
    @Thunk void performResizeAction(int action, View host, LauncherAppWidgetInfo info) {
        ...
        if (action == com.mytouch.launcher3.R.string.action_increase_width) {
            ...
            lp.cellHSpan ++;
            info.spanX ++;
        } else if (action == com.mytouch.launcher3.R.string.action_decrease_width) {
            lp.cellHSpan --;
            info.spanX --;
        } else if (action == com.mytouch.launcher3.R.string.action_increase_height) {
            if (!layout.isRegionVacant(info.cellX, info.cellY + info.spanY, info.spanX, 1)) {
                lp.cellY --;
                info.cellY --;
            }
            lp.cellVSpan ++;
            info.spanY ++;
        } else if (action == com.mytouch.launcher3.R.string.action_decrease_height) {
            lp.cellVSpan --;
            info.spanY --;
        }
        ...
        announceConfirmation(mLauncher.getString(com.mytouch.launcher3.R.string.widget_resized, info.spanX, info.spanY));
    }
