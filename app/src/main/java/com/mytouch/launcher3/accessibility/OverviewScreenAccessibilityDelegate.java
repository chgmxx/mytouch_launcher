...
public class OverviewScreenAccessibilityDelegate extends AccessibilityDelegate {
    ...
    private static final int MOVE_BACKWARD = com.mytouch.launcher3.R.id.action_move_screen_backwards;
    private static final int MOVE_FORWARD = com.mytouch.launcher3.R.id.action_move_screen_forwards;
    ...
    public OverviewScreenAccessibilityDelegate(Workspace workspace) {
        ...
        mActions.put(MOVE_BACKWARD, new AccessibilityAction(MOVE_BACKWARD,
                context.getText(isRtl ? com.mytouch.launcher3.R.string.action_move_screen_right :
                    com.mytouch.launcher3.R.string.action_move_screen_left)));
        mActions.put(MOVE_FORWARD, new AccessibilityAction(MOVE_FORWARD,
                context.getText(isRtl ? com.mytouch.launcher3.R.string.action_move_screen_left :
                    com.mytouch.launcher3.R.string.action_move_screen_right)));
    }
    ...
    private void movePage(int finalIndex, View view) {
        ...
        mWorkspace.announceForAccessibility(mWorkspace.getContext().getText(com.mytouch.launcher3.R.string.screen_moved));
