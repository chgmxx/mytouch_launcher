package com.mytouch.launcher3.testing;
...
import com.mytouch.launcher3.InsettableFrameLayout;
import com.mytouch.launcher3.Launcher;
import com.mytouch.launcher3.LauncherAnimUtils;
import com.mytouch.launcher3.LauncherCallbacks;
import com.mytouch.launcher3.allapps.AllAppsSearchBarController;
        ...
        class LauncherExtensionOverlay implements LauncherOverlay {
            ...
            public void setOverlayContainer(InsettableFrameLayout container) {
                mOverlayView = (ViewGroup) getLayoutInflater().inflate(
                        com.mytouch.launcher3.R.layout.launcher_overlay_example, container);
                mSearchOverlay = mOverlayView.findViewById(com.mytouch.launcher3.R.id.search_overlay);
                mSearchBox = mOverlayView.findViewById(com.mytouch.launcher3.R.id.search_box);
            }
