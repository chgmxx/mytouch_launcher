...
package com.mytouch.launcher3.widget;
...
public class WidgetsContainerView extends BaseContainerView
    ...
    protected void onFinishInflate() {
        ...
        mView = (WidgetsRecyclerView) findViewById(com.mytouch.launcher3.R.id.widgets_list_view);
    ...
    public View getRevealView() {
        ...
        return findViewById(com.mytouch.launcher3.R.id.widgets_reveal_view);
    }
    ...
    public void onClick(View v) {
        ...
        mWidgetInstructionToast = Toast.makeText(getContext(), com.mytouch.launcher3.R.string.long_press_widget_to_add,
                Toast.LENGTH_SHORT);
    ...
    private boolean beginDraggingWidget(WidgetCell v) {
        ...
        WidgetImageView image = (WidgetImageView) v.findViewById(com.mytouch.launcher3.R.id.widget_preview);
    ...
    protected void onUpdateBackgroundAndPaddings(Rect searchBarBounds, Rect padding) {
        ...
        InsetDrawable background = new InsetDrawable(
                getResources().getDrawable(com.mytouch.launcher3.R.drawable.quantum_panel_shape_dark), padding.left, 0,
                padding.right, 0);
